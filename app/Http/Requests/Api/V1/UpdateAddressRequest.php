...
class UpdateAddressRequest extends BaseAddressRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'data.attributes.streetName' => ['sometimes', 'string', 'max:132', 'min:3',],
            'data.attributes.houseNumber' => ['sometimes', 'string', 'max:32', 'min:3'],
            'data.attributes.city' => ['sometimes', 'string', 'max:32', 'min:3'],
